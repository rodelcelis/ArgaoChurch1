    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Approval for Schedule  MassConfirmation</h5>
            ...
            <input type="hidden" name="confirmationfill_id" value="<?php echo htmlspecialchars($confirmationfill_id); ?>" />
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">MassConfirmation View Information Form</div>
                    </div>
                    <div class="card-body">
